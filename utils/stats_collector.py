    ...
    async def get_user_stats(self, user_id: int) -> Optional[UserStats]:
        ...
        async with aiosqlite.connect(self.db_path) as db:
            ...
            return UserStats(
                ...
                first_interaction=datetime.fromisoformat(profile['first_interaction']) if profile['first_interaction'] else None,
                last_interaction=datetime.fromisoformat(profile['last_interaction']) if profile['last_interaction'] else None
            )
